            ...
            logger.log("Starting action", 0);
                ...
                while (serverResultSet.next()) {
                    ...
                    for (Map.Entry<String, HeatMapStats> entry : dateItems.entrySet()) {
                        HeatMapStats stats = new HeatMapStats();
                        ...
                        dateItems.put(entry.getKey(), stats);
                    }
    
                    logger.log("Finished one Heatmap processing", 0);
